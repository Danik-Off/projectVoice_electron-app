# -style Audio Settings

Полностью переписанные настройки аудио в стиле  с современным интерфейсом и улучшенной функциональностью.

## Компоненты

### AudioSettings.tsx
Основной компонент настроек аудио с -подобным дизайном:
...
### Дизайн
- **-стиль**: современный, чистый интерфейс
