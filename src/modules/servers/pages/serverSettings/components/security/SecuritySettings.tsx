...
const SecuritySettings: React.FC<SecuritySettingsProps> = observer(() => {
    ...
    const verificationLevels = [
        {
            value: 0,
            label: t('serverSettings.security.verificationNone') || 'Нет',
            description: t('serverSettings.security.verificationNoneDesc') || 'Нет требований'
        },
        {
            value: 1,
            label: t('serverSettings.security.verificationLow') || 'Низкий',
            description: t('serverSettings.security.verificationLowDesc') || 'Требуется подтвержденный email'
        },
        {
            value: 2,
            label: t('serverSettings.security.verificationMedium') || 'Средний',
            description:
                t('serverSettings.security.verificationMediumDesc') || 'Участник должен быть на сервере более 5 минут'
        },
        {
            value: 3,
            label: t('serverSettings.security.verificationHigh') || 'Высокий',
            description:
                t('serverSettings.security.verificationHighDesc') || 'Участник должен быть на сервере более 10 минут'
        },
        {
            value: 4,
            label: t('serverSettings.security.verificationVeryHigh') || 'Очень высокий',
            description: t('serverSettings.security.verificationVeryHighDesc') || 'Требуется номер телефона'
        }
    ];
    ...
    const explicitContentFilters = [
        {
            value: 0,
            label: t('serverSettings.security.filterDisabled') || 'Отключен',
            description: t('serverSettings.security.filterDisabledDesc') || 'Не сканировать содержимое'
        },
        {
            value: 1,
            label: t('serverSettings.security.filterMembers') || 'Участники без ролей',
            description: t('serverSettings.security.filterMembersDesc') || 'Сканировать только у участников без ролей'
        },
        {
            value: 2,
            label: t('serverSettings.security.filterAll') || 'Все участники',
            description: t('serverSettings.security.filterAllDesc') || 'Сканировать у всех участников'
        }
    ];
                    ...
                    <div className="card-header">
                        <div className="header-content">
                            ...
                            <div className="header-text">
                                ...
                                <p>
                                    {t('serverSettings.security.verificationLevelDesc') ||
                                        'Определяет требования для участников'}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="settings-card">
                    <div className="card-header">
                        <div className="header-content">
                            ...
                            <div className="header-text">
                                <h3>
                                    {t('serverSettings.security.explicitContentFilter') || 'Фильтр явного контента'}
                                </h3>
                                <p>
                                    {t('serverSettings.security.explicitContentFilterDesc') ||
                                        'Автоматическое удаление неприемлемого контента'}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="settings-card">
                    <div className="card-header">
                        <div className="header-content">
                            ...
                            <div className="header-text">
                                <h3>
                                    {t('serverSettings.security.defaultNotifications') || 'Уведомления по умолчанию'}
                                </h3>
                                <p>
                                    {t('serverSettings.security.defaultNotificationsDesc') ||
                                        'Настройки уведомлений для новых участников'}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="settings-card">
                    <div className="card-header">
                        <div className="header-content">
                            ...
                            <div className="header-text">
                                <h3>
                                    {t('serverSettings.security.require2FA') ||
                                        'Требовать двухфакторную аутентификацию'}
                                </h3>
                                <p>
                                    {t('serverSettings.security.require2FADesc') ||
                                        'Только участники с включенной 2FA смогут выполнять определенные действия'}
                                </p>
                            </div>
                        </div>
                    </div>
