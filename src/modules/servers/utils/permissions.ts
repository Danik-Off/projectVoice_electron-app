...
export const hasPermission = (
    ...
    const perms = typeof userPermissions === 'string' 
 ...
 */
export const permissionsToString = (permissions: bigint): string => {
 ...
 */
export const stringToPermissions = (permissions: string): bigint => {
...
export const combinePermissions = (
    permissions: Array<bigint | string>
): bigint => {
    return permissions.reduce((acc: bigint, perm) => {
